...
<form id="asd">
    <header>
        <div class="container">
            <h1>요투리</h1>
            <div>
                <input type="hidden" name="mnum" value="<%= mvo.getMnum() %>">
                <input type="hidden" name="mnick" value="<%= mvo.getMnick() %>">
                ...
                <a id="insertBtn" class="login-button post-button">게시글 작성</a>
            </div>
        </div>
        <div class="container">
            <nav>
                <ul>
                    <li><a href="http://localhost:8088/project11/main_1.jsp">추천</a></li>
    ...
    <main>
        <div class="content-container">
            ...
            <div class="slider" id="best-slider">
                <div class="slides">
                    <div class="slide"><img src="/project11/img/12.jpg" alt="Item 1"></div>
                    <div class="slide"><img src="/project11/img/5.jpg" alt="Item 2"></div>
                    <div class="slide"><img src="/project11/img/7.jpg" alt="Item 3"></div>
                    <div class="slide"><img src="/project11/img/8.jpg" alt="Item 4"></div>
                    <div class="slide"><img src="/project11/img/10.jpg" alt="Item 5"></div>
        ...
        <div class="content-container">
            ...
            <div class="slider" id="views-slider">
                <div class="slides">
                    <div class="slide"><img src="/project11/img/1.jpg" alt="Item 1"></div>
                    <div class="slide"><img src="/project11/img/11.jpg" alt="Item 2"></div>
                    <div class="slide"><img src="/project11/img/14.jpg" alt="Item 3"></div>
                    <div class="slide"><img src="/project11/img/9.jpg" alt="Item 4"></div>
                    <div class="slide"><img src="/project11/img/3.jpg" alt="Item 5"></div>
                    <div class="slide"><img src="/project11/img/9.jpg" alt="Item 9"></div>
                    <div class="slide"><img src="/project11/img/8.jpg" alt="Item 8"></div>
                    <div class="slide"><img src="/project11/img/7.jpg" alt="Item 7"></div>
                    <div class="slide"><img src="/project11/img/1.jpg" alt="Item 6"></div>
        ...
        <div class="content-container">
            ...
            <div class="slider" id="best1-slider">
                <div class="slides">
                    <div class="slide"><img src="/project11/img/7.jpg" alt="Item 1"></div>
                    <div class="slide"><img src="/project11/img/8.jpg" alt="Item 2"></div>
                    <div class="slide"><img src="/project11/img/9.jpg" alt="Item 3"></div>
                    <div class="slide"><img src="/project11/img/10.jpg" alt="Item 4"></div>
                    <div class="slide"><img src="/project11/img/11.jpg" alt="Item 5"></div>
                    <div class="slide"><img src="/project11/img/9.jpg" alt="Item 9"></div>
                    <div class="slide"><img src="/project11/img/8.jpg" alt="Item 8"></div>
                    <div class="slide"><img src="/project11/img/7.jpg" alt="Item 7"></div>
                    <div class="slide"><img src="/project11/img/1.jpg" alt="Item 6"></div>
...
<footer>
    ...
    <script>
        ...
        $(document).on("click", "#insertBtn", function(){
            $('#asd').attr({
                'action': 'postForm.k',
                'method': 'GET',  // 만약 GET이 아니라 POST로 데이터를 전송하려면 'POST'로 변경
